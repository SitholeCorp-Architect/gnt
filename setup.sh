...
echo
echo "Next: docs/self-hosting/README.md covers connecting a GitHub repo for rules."
echo "gnt login's browser step has nowhere to land in this repo (see README.md's"
echo "troubleshooting section) until you build a frontend for /cli-login or the CLI"
echo "gets a login flow that doesn't need one. docs/self-hosting/README.md covers"
echo "the production-hardening step before this goes anywhere near real data."
